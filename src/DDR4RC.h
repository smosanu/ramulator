...
public:
    ...
    enum class Org;
    enum class Speed;
    DDR4RC(Org org, Speed speed);
    DDR4RC(const string& org_str, const string& speed_str);
    ...
    /* Prereq */
    function<Command(DRAM<DDR4RC>*, Command cmd, int)> prereq[int(Level::MAX)][int(Command::MAX)];

    // SAUGATA: added function object container for row hit status
    /* Row hit */
    function<bool(DRAM<DDR4RC>*, Command cmd, int)> rowhit[int(Level::MAX)][int(Command::MAX)];
    function<bool(DRAM<DDR4RC>*, Command cmd, int)> rowopen[int(Level::MAX)][int(Command::MAX)];
    ...
    /* Lambda */
    function<void(DRAM<DDR4RC>*, int)> lambda[int(Level::MAX)][int(Command::MAX)];

    /* Organization */
    enum class Org : int
    {
        DDR4RC_2Gb_x4,   DDR4RC_2Gb_x8,   DDR4RC_2Gb_x16,
        DDR4RC_4Gb_x4,   DDR4RC_4Gb_x8,   DDR4RC_4Gb_x16,
        DDR4RC_8Gb_x4,   DDR4RC_8Gb_x8,   DDR4RC_8Gb_x16,
        MAX
    };
    ...
    {
        DDR4RC_1600K, DDR4RC_1600L,
        DDR4RC_1866M, DDR4RC_1866N,
        DDR4RC_2133P, DDR4RC_2133R,
        DDR4RC_2400R, DDR4RC_2400U,
        DDR4RC_3200,
        MAX
    };
